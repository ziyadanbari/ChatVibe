...
export default function UserPaper({
  ...
  const MessageIcon = messagesIcons[lastMessage?.message?.messageType];
  return (
    <div className="p-2 rounded-sm hover:bg-main-dark-gray cursor-pointer flex justify-between items-center gap-1">
      <div className="flex items-center gap-2 flex-1">
        ...
        <div className="flex gap-1 flex-1 flex-col">
          ...
          {lastMessage && (
            <div className="flex items-center gap-1 text-sm text-main-gray">
              <div>
                <MessageIcon size={19} />
              </div>
              <div className=" whitespace-nowrap line-clamp-1">
                {lastMessage?.message?.messageType === "text"
                  ...
                  : messagesType[lastMessage?.message?.messageType]}
              </div>
            </div>
          )}
        </div>
