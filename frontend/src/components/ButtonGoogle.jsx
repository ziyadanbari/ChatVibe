...
import { googleOAuthUrl } from "@/constants/index.jsx";

export default function ButtonGoogle() {
  return (
    <div>
      <a href={googleOAuthUrl}>
        <Button className="flex justify-center w-full gap-3 ">
          <div>
            <svg
              height={"24px"}
          ...
          <div className="font-semibold text-sm">Continue with google</div>
        </Button>
      </a>
    </div>
  );
